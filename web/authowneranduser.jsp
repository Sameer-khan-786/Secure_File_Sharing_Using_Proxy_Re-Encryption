    ...
    <div class="container d-flex justify-content-between" >
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="authowneranduser.jsp">Authorize Owners and Users</a></li>
                    ...
                    <style>
                        table,tr,th,td{
                          ...
                          <table style=" margin-left: 400px; margin-bottom: 100px;">
                            ...
                            <th style=" background-color: #0dcaf0;">Username</th>
                      ...
                      <%   
                        ...
                        <tr>
                            ...
                            <td><%=rs.getString("user")%></td>  
                             ...
                             <td > <a href="oauth.jsp?id=<%=rs.getString("id")%>" style="color:  #007aff; "><%=rs.getString("status")%></a></td></tr>
                             
                        <%}%></table> 
  
                        <h2 style="  color:#3498db ; text-align: center; font-size: 25px; font-weight: bolder; margin-left:-180px; "> Authorize Users!!</h2>
                          <br>
                          <table style=" margin-left: 400px; margin-bottom: 100px;">
                              <tr>
                            <th  style=" background-color: #0dcaf0;">ID</th>
                      ...
                      <%   
                        ...
                        Class.forName("com.mysql.cj.jdbc.Driver");
                        Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/proxy","root","Sameer@786");
                        PreparedStatement query1=con.prepareStatement("select * from ureg  ");
                        ...
                        <tr>
                            ...
                            <td><%=rs1.getString("user")%></td>  
                             ...
                             <td > <a href="uauth.jsp?id=<%=rs1.getString("id")%>" style="color: #007aff; "><%=rs1.getString("status")%></a></td></tr>
